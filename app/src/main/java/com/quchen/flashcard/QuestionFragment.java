...
public class QuestionFragment extends Fragment {
    ...
    /**
     * @param wrongTv может быть null в случае выбора правильного ответа
     * @param correctTv Не может быть Null.
     */
    ...
    private final View.OnClickListener answerOnClick = view -> {
        ...
        // Отключение события нажатия на момент работы анимации
        for (TextView tv : getAnswerTextViews()) {
    ...
    // Хранение расфасованного списка, так, чтобы следующий nextCardView был идентичен им же сверху
